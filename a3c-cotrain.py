...
tf.summary.scalar("score1", score_input1)
tf.summary.scalar("score2", score_input2)
  ...
  while True:
    ...
    if parallel_index % 2 == 0:
        diff_global_t = training_thread.process(sess, global_t, summary_writer,
                                            summary_op, score_input1)
    elif parallel_index % 2 == 1:
        diff_global_t = training_thread.process(sess, global_t, summary_writer, summary_op, score_input2)
    else:
