...
from constants_cotrain_factorized import GAMMA
from constants_cotrain_factorized import LOCAL_T_MAX
from constants_cotrain_factorized import ENTROPY_BETA
...
class A3CTrainingThread(object):
    def __init__(self,
        ...
        if thread_index % 2 == 0:
            print(global_network.get_vars_1())
    ...
    def process(self, sess, global_t, summary_writer, summary_op, score_input):
        ...
        for i in range(LOCAL_T_MAX):
            ...
            if (self.thread_index == 0 or self.thread_index == 1) and (self.local_t % LOG_INTERVAL == 0):
